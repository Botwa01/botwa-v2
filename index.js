...
/******** OWNER NUMBER**********/
const ownerNumber = ["6285855205638@s.whatsapp.net","6289509341010@s.whatsapp.net"] 
/************************************/
	...
	client.on('message-new', async (mek) => {
		try {
          ...
          if (!isRegistered) return reply(ind.noregis())
            ...
            case 'owner':
            case 'creator':
                  client.sendMessage(from, {displayname: "Yon_ShopFF", vcard: vcard}, MessageType.contact, { quoted: mek})
